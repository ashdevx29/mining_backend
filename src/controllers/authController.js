...
//     // Generate Referral Code (Yeh hamesha generate hona chahiye)
//     const crypto = require('crypto');
//     const newReferralCode = crypto.randomBytes(4).toString('hex').toUpperCase() + 
//                            Math.floor(Math.random() * 1000).toString().padStart(3, '0');
...
//         referredBy = referrer._id;
//         referrer.totalReferrals = (referrer.totalReferrals || 0) + 1;
//         referrer.referralMiningBonus = (referrer.referralMiningBonus || 0) + 1;
//         await referrer.save();
//       }
//     }
...
//       phone,
//       password: hashedPassword,
//       referralCode: newReferralCode,        // ← Yeh line important hai
//       referredBy,
//       totalReferrals: 0,
//       referralMiningBonus: 0,
//       balance: 0,
//       totalMined: 0
//     });
...
//       success: true,
//       message: "Account created successfully!",
//       referralCode: newReferralCode   // Frontend ko bhi code return kar rahe hain
//     });
...
//   try {
//     // If using refresh tokens, blacklist them here
//     res.json({ success: true, message: "Logged out successfully" });
//   } catch (err) {
//     res.status(500).json({ success: false, message: "Logout failed" });
//   }
